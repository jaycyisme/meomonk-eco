...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/product-size-chart.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2024 15:08:16 GMT -->
<head>
...
<body>
                        ...
                        <div class="col-xl-6 wow fadeInUp">
                            <div class="right-box-contain">
                                ...
                                <ul class="feature-list">
                                    <li>
                                        <a href="#chart" data-bs-toggle="modal">
                                            <svg>
                                    ...
                                    <li>
                                        <a href="#question" data-bs-toggle="modal">
                        ...
                        <div class="tab-content custom-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="description" role="tabpanel">
                                <div class="product-description">
                                    <div class="nav-desh">
                                        <p>Introducing our Solid Collared Tshirts, the ultimate fashion statement for
                                            the modern individual. Crafted with meticulous attention to detail, these
                                            versatile shirts effortlessly elevate your style game while providing
                                            unmatched comfort.</p>
                                        <p>Made from premium quality materials, our collared t-shirts are designed to
                                            withstand the test of time. The solid color palette offers a timeless
                                            appeal, ensuring you stay on-trend no matter the occasion. Whether you're
                                            attending a formal event or simply going for a casual outing, these shirts
                                            are the perfect choice to exude professionalism and sophistication.</p>
                                        <p>Not only do our Solid Collared Tshirts enhance your overall appearance, but
                                            they also prioritize comfort. The breathable fabric ensures proper
                                            ventilation, keeping you cool and confident throughout the day. The collar
                                            adds a touch of elegance, making these shirts a versatile addition to your
                                            wardrobe.</p>
                                        <p>With a wide range of sizes available, finding the perfect fit has never been
                                            easier. Our Solid Collared Tshirts are tailored to meet the demands of the
                                            modern lifestyle, allowing you to effortlessly transition from the office to
                                            after-work social gatherings.</p>
                                        <p>Invest in our Solid Collared Tshirts today and experience the epitome of
                                            fashion and comfort. Elevate your style game and make a lasting impression
                                            wherever you go. Order now and discover why our customers rave about these
                                            wardrobe staples.</p>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Chart Modal Start -->
    <div class="modal fade theme-modal" id="chart" tabindex="-1">
    ...
    <div class="modal fade theme-modal delivery-modal" id="delivery" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="exampleModalLabel">Delivery & Return</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                        <i class="fa-solid fa-xmark"></i>
                    </button>
                </div>
                <div class="modal-body policy-body">
                    <p>Shipping and Returns are integral parts of your shopping experience, and we aim to make them as
                        smooth as possible. We prioritize efficient shipping, striving to deliver your orders promptly
                        within the estimated delivery window, typically ranging from 5 to 7 days. We understand that
                        sometimes your purchase may not meet your expectations, so we offer a straightforward return
                        policy. If you find yourself unsatisfied with your order, eligible items can be returned within
                        30 days of purchase, ensuring you have ample time to make a decision. Our commitment is to
                        ensure your satisfaction and convenience throughout your shopping journey with us, and we're
                    ...
                    <ul>
                        ...
                        <li>Exceptional packaging to ensure your items arrive in perfect condition.</li>
                    </ul>
                    ...
                    <p>We understand that your shopping needs may vary, and we are here to accommodate them
                        while providing exceptional service.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade theme-modal question-modal" id="question" tabindex="-1">

...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/product-expert.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2024 15:08:17 GMT -->
<head>
...
<body>
                        ...
                        <div class="col-xl-6 wow fadeInUp">
                            <div class="right-box-contain">
                                ...
                                <div class="dynamic-checkout">
                                    <button class="bg-theme btn btn-md">
                                        <div> Buy Now </div>
                                    </button>
                                    <button class="border-theme-color btn btn-md scroll-button" type="submit">
                                        <div><i class="ri-shopping-cart-line me-1"></i> Add to Cart </div>
                                    </button>
                                </div>
                ...
                <div class="col-12">
                    <div class="product-section-box m-0">
                        <ul class="nav nav-tabs custom-nav" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="info-tab" data-bs-toggle="tab"
                                    data-bs-target="#questionanswer" type="button" role="tab">Q & A</button>
                            </li>
                        ...
                        <div class="tab-content custom-tab" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="questionanswer" role="tabpanel">
                                <div class="post-question-box ">
                                    <h4>Have Doubts Regarding This Product ? <a href="#questionanswer1"
                                            data-bs-toggle="modal">Post Your Question</a></h4>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="question-box">
                                                ...
                                                <h6 class="font-weight-bold que">
                                                    How can I find out about product recalls?</h6>
                                                <ul class="link-dislike-box">
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <span><i data-feather="thumbs-up"></i> 0</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <span><i data-feather="thumbs-down"></i> 0</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="answer-box">
                                                <div class="answer-box ">
                                                    <h5>A1</h5>
                                                    <p class="ans">Check the
                                                        product's official website, the manufacturer's website,
                                                        or government websites for recalls. You can also sign up
                                                        for email alerts from consumer protection organizations.
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="question-box">
                                                <h5>Q2</h5>
                                                <h6 class="font-weight-bold que">
                                                    What should I do if a product arrives damaged?</h6>
                                                <ul class="link-dislike-box">
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <span><i data-feather="thumbs-up"></i> 0</span>
                                            ...
                                            <div class="answer-box">
                                                <div class="answer-box ">
                                                    <h5>A2</h5>
                                                    <p class="ans">Contact the
                                                        retailer's customer service immediately. Most retailers
                                                        have a process for handling damaged or defective items
                                                        and may offer a replacement or refund. </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="question-box">
                                                <h5>Q3</h5>
                                                <h6 class="font-weight-bold que">
                                                    Can I cancel an order after it has been placed?</h6>
                                                <ul class="link-dislike-box">
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <span><i data-feather="thumbs-up"></i> 0</span>
                                            ...
                                            <div class="answer-box">
                                                <div class="answer-box ">
                                                    <h5>A3</h5>
                                                    <p class="ans">It depends on
                                                        the retailer and the stage of processing. Quickly
                                        ...
                                        <li>
                                            ...
                                            <div class="answer-box">
                                                <div class="answer-box ">
                                                    <h5>A4</h5>
                                                    <p class="ans">Online reviews
                                                        can be helpful, but it's essential to consider the
                                                        overall sentiment and read multiple reviews. Look for
                                                        detailed reviews and consider the source's credibility.
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="answer-box">
                                                <div class="answer-box ">
                                                    <h5>A5</h5>
                                                    <p class="ans">Subscribe to
                                                        newsletters, follow retailers on social media, and use
                                                        price comparison tools. Many retailers also offer
                                                        discounts for first-time shoppers or during seasonal
                                                        sales. </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="question-box">
                                                <h5>Q6</h5>
                                                <h6 class="font-weight-bold que">
                                                    What is the return policy for most products?</h6>
                                                <ul class="link-dislike-box">
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <span><i data-feather="thumbs-up"></i> 0</span>
                                            ...
                                            <div class="answer-box">
                                                <div class="answer-box ">
                                                    <h5>A6</h5>
                                                    <p class="ans">Return policies
                                                        vary by retailer. Typically, there is a specified window
                                                        (e.g., 30 days) for returns. Check the retailer's
                                                        website or contact customer service for specific
                                                        details. </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="question-box">
                                                <h5>Q7</h5>
                                                <h6 class="font-weight-bold que">
                                                    How can I track my online order?</h6>
                                                <ul class="link-dislike-box">
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <span><i data-feather="thumbs-up"></i> 0</span>
                                            ...
                                            <div class="answer-box">
                                                <div class="answer-box ">
                                                    <h5>A7</h5>
                                                    <p class="ans">Most online
                                                        retailers provide a tracking number in your order
                                                        confirmation email. You can use this number on the
                                                        carrier's website to track the status and location of
                                                        your package. </p>
                                                </div>
                                            </div>
                                        </li>
    ...
    <!-- Question Answer Modal Start -->
    <div class="modal fade theme-modal" id="questionanswer1" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body pt-0">
                    <form class="product-review-form">
                        <div class="product-wrapper">
                            <div class="product-image">
                                <img class="img-fluid" src="../assets/images/fashion/product/23.jpg"
                                    alt="Premium Blazer">
                            </div>
                            <div class="product-content">
                                <h5 class="name">Premium Blazer</h5>
                                <div class="product-review-rating">
                                    <div class="product-rating">
                                        <h6 class="price-number">$ 9.90</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-md btn-theme-outline fw-bold" type="button">
                        <div>Cancel</div>
                    </button>
                    <button class="btn btn-md fw-bold text-light theme-bg-color" type="submit">
                        <div> Submit </div>
                    </button>
                </div>
            </div>

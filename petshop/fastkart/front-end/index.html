                    ...
                    <div class="offcanvas-body">
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <div
                            class="dropdown-menu dropdown-menu-3 dropdown-menu-2"
                          >
                            <div class="row">
                              <div class="col-xl-3">
                                <div class="dropdown-column m-0">
                                  <h5 class="dropdown-header">Product Pages</h5>
                                  <a
                                    class="dropdown-item"
                                    href="product-left-thumbnail.html"
                                    >Product Thumbnail</a
                              ...
                              <div class="col-xl-3">
                                <div class="dropdown-column m-0">
                                  ...
                                  <a
                                    ...
                                    href="product-image.html"
                                    >Social Share
                                    <label class="menu-label warning-label"
                                      >Hot</label
                                    >
                                  </a>
                                  <a
          ...
          <div>
            <div class="banner-contain hover-effect">
              ...
              <div class="banner-details">
                ...
                <a
                  href="shop-left-sidebar.html"
                  class="banner-button text-white"

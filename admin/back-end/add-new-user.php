...
<div class="page-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" >
                                                    <form class="theme-form theme-form-2 mega-form" action="../controller/ControllerUser.php" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                include("../database/model/Role.php");
                                                                include("../database/business/RoleBN.php");
    ...
    <div style="display: flex;justify-content: flex-end; margin:0 215px 50px 0"><a class="btn btn-solid" href="add-new-product.html" style="width: 200px;">Add User</a></div>
